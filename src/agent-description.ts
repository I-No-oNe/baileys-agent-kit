...
export const agentDescription = {
  ...
  purpose: "Operate a linked WhatsApp account through validated Baileys actions.",
  ...
  commands: {
    ...
    pair: "Link WhatsApp with a terminal QR, protected PNG, or optional private browser link.",
